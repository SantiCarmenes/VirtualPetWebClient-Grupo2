  ...
  return (
    <footer className="bg-card border-t border-border mt-auto">
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="space-y-3">
            ...
            <div className="flex items-center gap-3">
              ...
              <a href="#" aria-label="X / Twitter" className="w-9 h-9 rounded-full border border-border flex items-center justify-center text-muted-foreground hover:text-primary hover:border-primary transition-colors">
                <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4">
          ...
          <div>
            <h4 className="font-semibold mb-3 text-sm">Ayuda</h4>
        ...
        <div className="border-t border-border mt-6 pt-5 text-center text-xs text-muted-foreground">
